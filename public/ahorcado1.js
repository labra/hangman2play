...
function getPalabras() {
 var words = palabrasOffline ;
 $.getJSON("words/es.json", procesaPalabras);
 //Si no se pueden obtener de otro sitio, coger las predefinidas...
 alert("getPalabras, Words:" + words);
 return words;

}

function procesaPalabras(data) {
	var output = "<ul>"
	...
	alert("Procesa Palabras, Words:" + words);
}
